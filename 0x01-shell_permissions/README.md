The '0-iam betty' file switches the current user to the user betty.
...
The '101-symbolic l ink permissions' file changes  the owner and the group owner of _hello to vincent and staff respectively.
